...
Find the test set in the following [link](https://drive.google.com/drive/folders/0BydaU2Imk1zjQjVXbmwxT1RsSVU?usp=sharing). The test set labels will not be disclosed but getting the test scores will be possible by uploading the results to CodaLab _soon_.
